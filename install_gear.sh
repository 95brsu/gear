...
echo "-----------------------------------------------------------------------------"
curl -s https://raw.githubusercontent.com/95brsu/tools/main/install_ufw.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/95brsu/tools/main/install_rust.sh | bash &>/dev/null
...
echo "Билд завершен успешно, желаю удачи!!!"
echo "-----------------------------------------------------------------------------"
